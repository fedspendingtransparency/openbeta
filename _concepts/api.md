...
copy:
  - text: <a class="usa-cta external-link" href="http://52.222.54.147/api/v1/awards/" target="_blank">Access the Alpha Outbound API</a>
...
tabs:
  - title: Version 0.1A
    ...
    archived_text:
    disclaimer_text: <a class="usa-cta external-link" href="http://52.222.54.147/api/v1/awards/ target="_blank">Access the Alpha Outbound API</a>
