...
copy:
  - text: <a class="usa-cta external-link" href="https://hyperlink.services.treasury.gov/?origin=https://usaspending-api-stg-elb-2084332242.us-gov-west-1.elb.amazonaws.com/api/v1/awards/summary/" target="_blank">Access the Alpha Outbound API</a>
...
tabs:
  - title: Version 0.1A
    ...
    archived_text:
    disclaimer_text: <a class="usa-cta external-link" href="http://usaspending-api-prod-elb-2008705896.us-gov-west-1.elb.amazonaws.com/api/v1/awards/summary/" target="_blank">Access the Alpha Outbound API</a>
